...
const MemeDetailPage = () => {
  ...
  if (loading)
    return <p className="text-center py-10 text-gray-400">⏳ 로딩 중...</p>;
  if (!meme)
    return <p className="text-center py-10 text-gray-500">데이터 없음</p>;
    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b font-GowunBatang">
      ...
      <main className="flex-grow container mx-auto px-6 py-10">
        ...
        <section className="flex justify-center mt-10 items-center gap-3">
          ...
          <span className="text-gray-700 font-GowunBatangBold text-lg">
            총 {likesCount} 송이
          </span>
        </section>
        <div className="flex justify-end gap-3">
          <button
            className="bg-green-700 text-white px-4 py-2 rounded hover:bg-green-300 transition-colors"
            onClick={() => navigate(`/meme/update/${code}`)}
          >
            밈 수정하기
          </button>
          <button
            className="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-300 transition-colors"
        ...
        <section className="flex justify-end mt-10">
          <button
            className="font-GowunBatang mx-3 my-5 bg-gray-200 text-black px-4 py-2 rounded hover:bg-blue-300 transition-colors duration-300"
