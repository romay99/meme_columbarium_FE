    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b font-GowunBatang">
      ...
      <main className="flex-grow container mx-auto px-6 py-10">
        ...
        <div className="flex justify-end gap-3">
          <button className="bg-green-700 text-white px-4 py-2 rounded hover:bg-green-300 transition-colors" onClick={() => navigate(`/meme/update/${code}`)}>
            밈 수정하기
          </button>
          <button className="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-300 transition-colors" onClick={() => navigate(`/meme/update/${code}`)}>
            수정기록 열람
          </button>
        </div>
