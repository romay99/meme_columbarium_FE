...
const MemeDetailPage = () => {
  ...
  return (
    <div
      className={`flex flex-col min-h-screen font-GowunBatang transition-colors duration-500 ${
    ...
    >
      ...
      <main className="flex-grow container mx-auto px-6 py-10">
        ...
        <div
          className={`mx-16 min-h-[200px] rounded-xl border ${
            darkMode
              ? 'bg-black-900 border-gray-700'
        ...
        <section className="flex justify-center mt-10 items-center gap-3">
          ...
          <span className="font-GowunBatangBold text-lg">
            총 {likesCount} 송이
          </span>
        </section>
        ...
        <section className="flex justify-end mt-10">
          <button
            ...
            className={`mx-3 my-5 px-4 py-2 rounded ${
              darkMode
