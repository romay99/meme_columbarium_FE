          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex gap-2 mt-1">
                <input
                  ...
                  required
                  className="flex-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 p-3"
                  placeholder="아이디를 입력하세요"
                />
                <button
                  type="button"
                  onClick={checkId}
                  className="px-4 rounded-xl bg-gray-300 hover:bg-gray-400 transition"
                >
                  중복확인
                </button>
              </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="mt-1 w-full rounded-xl border-gray-300 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 p-3"
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                required
                className={`mt-1 w-full rounded-xl border shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 p-3 ${
