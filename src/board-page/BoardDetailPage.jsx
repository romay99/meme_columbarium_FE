  ...
  return (
    <div>
      ...
      <main className="flex-grow container mx-auto px-6 py-10">
        {/* 게시글 제목 */}
        <div className="mx-5 text-4xl font-bold text-left mb-6 tracking-wide text-black-100">{board.title}</div>
        {/* 작성자 */}
        <div className="mx-5 text-xs font-GowunBatang text-left mb-6 tracking-wide text-black-100">작성자 : {board.authorNickName}</div>
        {/* 게시글 내용 */}
